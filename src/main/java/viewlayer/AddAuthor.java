...
/**
 * This class as the special Servlet adds an new author 
 * with first name and last name to the Books database.
 * 
...
public class AddAuthor extends HttpServlet {
    ...
    /**
     * This is the default constructor for AddAuthor.
     */
    public AddAuthor() {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<HTML>");
            out.println("<HEAD>");
            out.println("<TITLE>Add An Author</TITLE>");
            out.println("</HEAD>");
            out.println("<BODY BGCOLOR=\"#FDF5E6\">");
            out.println("<CENTER>");
            
            out.println("<H1>Add an author</H1>");
            
            out.println("<FORM ACTION=\"" + request.getContextPath() + "/AddAuthor-URL\" METHOD=\"POST\">");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        author = new AuthorDTO(firstName, lastName);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<H1>Get All Authors After Adding</H1>");
