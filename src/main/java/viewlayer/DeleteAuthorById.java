...
/**
 * This class as the special Servlet deletes an author by its AuthorID from the Books database.
 * 
 ...
 */
public class DeleteAuthorById extends HttpServlet {
    ...
    /**
     * This is the default constructor for DeleteAuthorById.
     */
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<HTML>");
            out.println("<HEAD>");
            out.println("<TITLE>Delete An Author</TITLE>");
            out.println("</HEAD>");
            out.println("<BODY BGCOLOR=\"#FDF5E6\">");
            out.println("<CENTER>");
            
            out.println("<H1>Delete An Author</H1>");
            
            out.println("<FORM ACTION=\"" + request.getContextPath() + "/DeleteAuthorById-URL\" METHOD=\"POST\">");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (author != null) {
                ...
                out.println("<H2>Deleting Successfully.</H2>");
            } else {
